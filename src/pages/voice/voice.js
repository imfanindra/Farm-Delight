...
const Voice = () => {
    ...
    return ( <
        ...
        default language is English < /div> <
        div className = "ml-16 " >
        <
        button onClick = {
            () => setLang("en") }
        ...
        <
        p className = "text-2xl font-medium text-green-600" > { organic1Title } <
        br / >
        <
        /p> { /*<p className="text-lg font-medium">{organic1.toString()}<br /></p>*/ } { organic1 } <
        ...
        div className = "my-10 p-6 bg-gray-300 bg-opacity-30 border border-gray-900 border-opacity-10" >
        <
        p className = "text-2xl font-medium text-green-600" > { organic2Title } <
        br / >
        <
        /p> { /*<p className="text-lg font-medium">{organic1.toString()}<br /></p>*/ } { organic2 } <
        div className = "flex flex-row place-content-end" >
        <
        p className = "text-xs font-medium text-green-600" >
        <
        ...
        { /*  <p className="text-2xl font-medium text-green-600">{organic3Title}<br /></p>*/ } { /*  /!*<p className="text-lg font-medium">{organic1.toString()}<br /></p>*!/*/ } { /*  {organic3.toString()}*/ } { /*  <div className="flex flex-row place-content-end">*/ } { /*    <p className="text-xs font-medium text-green-600"><a href={organic3Link}>Read More</a></p>*/ } { /*  </div>*/ }

        { /*</div>*/ }

        { /*<div className="my-10 p-6 bg-gray-300 bg-opacity-30 border border-gray-900 border-opacity-10"*/ } { /*>*/ }

        { /*  <p className="text-2xl font-medium text-green-600">{organic4Title}<br /></p>*/ } { /*  /!*<p className="text-lg font-medium">{organic1.toString()}<br /></p>*!/*/ } { /*  {organic4.toString()}*/ } { /*  <div className="flex flex-row place-content-end">*/ } { /*    <p className="text-xs font-medium text-green-600"><a href={organic4Link}>Read More</a></p>*/ } { /*  </div>*/ }

        { /*</div>*/ }

        { /*<div className="my-10 p-6 bg-gray-300 bg-opacity-30 border border-gray-900 border-opacity-10"*/ } { /*>*/ }

        { /*  <p className="text-2xl font-medium text-green-600">{organic5Title}<br /></p>*/ } { /*  /!*<p className="text-lg font-medium">{organic1.toString()}<br /></p>*!/*/ } { /*  {organic5.toString()}*/ } { /*  <div className="flex flex-row place-content-end">*/ } { /*    <p className="text-xs font-medium text-green-600"><a href={organic5Link}>Read More</a></p>*/ } { /*  </div>*/ }
