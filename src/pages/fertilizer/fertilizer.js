...
const Fertilizer = () => {
    ...
    return ( <
        ...
        <
        input onChange = {
            (e) => setPhosphorus(e.target.value) }
        className = "w-3/5 my-2"
        type = "text"
