...
const Footer = () => {
  ...
  return (
    <div className="bg-[#229ad6] inPhone py-20">
      <div className="flex justify-center items-center">
        <div className="flex-1 border-r-2 border-black-600">
          ...
          >
            ...
            <div className="ml-4">
              <h3 className="text-2xl text-white font-bold mt-4">Farmers Delight</h3>
        ...
        <div className="flex-1 flex mr-6">
          <img src="https://www.pngfind.com/pngs/m/613-6131138_vit-bhopal-logo-vit-bhopal-logo-png-transparent.png" className="footerBgImg" alt="" />
